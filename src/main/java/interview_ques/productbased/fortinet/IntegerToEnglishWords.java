package interview_ques.productbased.fortinet;
...
public class IntegerToEnglishWords {
    public static void main(String[] args) {
        ...
        System.out.println("The number " +num+ " spelled as ::: " +ans);
    ...
    private static String numberToWords(int num) {
        ...
        return numberToWords(num/100000000) + " Billion" + (num%1000000000!=0 ? " " + numberToWords(num%1000000000):"");
    }
}
