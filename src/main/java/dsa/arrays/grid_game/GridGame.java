package dsa.arrays.grid_game;

// Topics: Arrays, Matrix, PrefixSum
// Difficulty: Medium
...
// The first robot wants to minimize the number of points collected by the second robot. In contrast, the second robot wants to
// maximize the number of points it collects. If both robots play optimally, return the number of points collected by the second robot.
