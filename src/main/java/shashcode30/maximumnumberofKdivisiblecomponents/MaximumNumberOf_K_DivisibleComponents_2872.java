package shashcode30.maximumnumberofKdivisiblecomponents;

// Difficulty: Hard

// There is an undirected tree with n nodes labeled from 0 to n - 1.
// You are given the integer n and a 2D integer array edges of length n - 1, where edges[i] = [ai, bi] indicates that
...
public class MaximumNumberOf_K_DivisibleComponents_2872 {
    ...
    private static long dfs(int currentNode, int parentNode, List<Integer>[] adjList, int[] nodeValues, int k, int[] componentCount) {
        long sum = 0;
